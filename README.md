...
| <a name="input_pi_ssh_key_visibility"></a> [pi\_ssh\_key\_visibility](#input\_pi\_ssh\_key\_visibility) | Visibility of the Public SSH key in the PowerVS workspace. Allowed values: 'account', 'workspace'. | `string` | `"account"` | no |
