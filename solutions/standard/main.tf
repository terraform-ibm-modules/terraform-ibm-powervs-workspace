...
module "powervs_workspace" {
  ...
  pi_resource_group_name                  = var.existing_resource_group_id == null ? local.powervs_resource_group_name : null
  pi_resource_group_id                    = local.powervs_resource_group_name == null ? local.powervs_resource_group_id : null
