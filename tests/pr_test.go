...
const completeExampleDir = "solutions/standard"
...
func setupOptions(t *testing.T, prefix string, dir string, powervs_zone string) *testhelper.TestOptions {
	...
	options.TerraformVars = map[string]interface{}{
		...
		"powervs_public_network_enable": true,
	}
	return options
}
...
func TestRunBranchExample(t *testing.T) {
	...
	options := setupOptions(t, "pvs-ws-b", completeExampleDir, "osa21")
...
func TestRunMainExample(t *testing.T) {
	...
	options := setupOptions(t, "pvs-ws-m", completeExampleDir, "sao04")
